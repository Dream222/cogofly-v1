...
class RegisterView(FormView):
    ...
    def form_valid(self, form):
        ...
        if 'development' not in self.request.META['HTTP_HOST']:
            EmailMessage(
                subject=_(u'Thanks for registering!').encode('utf_8'),
                body=u'{}\n{}\n{}\n{}{}'.format(
                    _(u"Thanks again for signing up."),
                    _(u"We sincerely hope that you will appreciate this "
                      u"new and innovative international social network, "
                      u"for which the operative word is “sharing”"),
                    _(u"To validate your registration, "
        ...
        if p:
            if p.user.is_active:
                ...
                if p.reset_password:
                    ...
                    if nb < 3600:
                        ...
                        if user is not None:
                            ...
                            request.session['message'] = [
                                ...
                                u'{}{}'.format(
                                    _(u"<b>Please change your password</b>"),
                                    u"<script>"
                                    u"$(document).ready(function() { "
                                    u"$('#profile-summary').hide();\n"
                                    u"$('#my-parameters').show();\n"
                                    u"$('#my-parameters-tab').hide();\n"
                    ...
                    request.session['message'] = [
                        _(u"Request refused"),
                        _(u"Password reset is valid for one hour"),
                        _(u"Please try again"),
                        _(u"Click here to hide this message")]
                else:
                    ...
                    request.session['message'] = [
                        _(u"Already done"),
                        _(u"You have already activated this account"),
                        _(u"Please log-in"),
                        _(u"Click here to hide this message")]
