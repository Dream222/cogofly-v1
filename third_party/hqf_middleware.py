            ...
            if not p.site_language or p.site_language.locale != langue:
                try:
                    ...
                    request.session['message'] = [
                        str(_(u"Language unknown")),
                        str(_(u"The language you've set is unknown ('{}'). "
                              u"Please go to My Profile -> Change my "
                              u"parameters and choose a known language")
                            ).format(translation.get_language()),
                        str(_(u'Click here to hide this message')), ]
