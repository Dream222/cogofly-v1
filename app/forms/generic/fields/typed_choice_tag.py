...
class TagTypedChoiceField(forms.TypedChoiceField):
    ...
    def to_array(x):
        try:
            ...
            raise ValidationError(_(u'List required'), code='required')
    ...
    def __init__(self, *args, **kwargs):
        if kwargs.pop('coerce', None):
            raise FieldError(_(u"coerce is overriden"), code='required')
        ...
        if not isinstance(self.empty_values, list):
            raise FieldError(_(u'Empty: list required'), code='required')
            ...
            if isinstance(v, (int, long)):
                ...
                try:
                    ...
                    try:
                        ...
                        raise FieldError(_(u"custom_tag: result should be int"),
                                         code='required')
    ...
    def validate(self, value):
        ...
        if not all(isinstance(item, int) for item in value):
            raise ValidationError(_(u'List of int required'), code='required')
