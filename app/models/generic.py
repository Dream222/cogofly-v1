...
class BaseModel(models.Model):
    ...
    date_last_modif = models.DateTimeField(auto_now=True,
                                           verbose_name=_(u'Last changed'))
    date_v_debut = models.DateTimeField(
        default=timezone.now,
        editable=True,
        verbose_name=_(u"V. start")
    )
    ...
    def image_tag(self):
        if self.image:
            return u'<img src="{0}" ' \
                   u'style="width:200px; height:auto;"s/>'.format(
    ...
    def date_relative(d, most_recent=None):
        ...
        if diff.days > 7 or diff.days < 0:
            ...
            return _(u"1 day ago")
        elif diff.days > 1:
            return _(u"{} days ago").format(diff.days)
        elif s <= 1:
            return _(u"Just now")
        elif s < 60:
            ...
            return _(u"{} hours ago").format(s / 3600)
...
class Langue(BaseModel):
    ...
    def url_drapeau(self):
        ...
        a = u'img/flags/flag-{}-s.png'.format(self.locale)
    ...
    def __str__(self):
        return u'{} / {}{}'.format(
            self.locale, self.nom, (_(u"- activated") if self.active else "")
        )
