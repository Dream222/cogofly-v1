...
class ProgressionMixin:
    ...
    def progression(user, personne):
        ...
        local_add(user.first_name, _(u"first name"), 5.0)
        local_add(user.last_name, _(u"last name"), 5.0)
        local_add(user.email, _(u"email"), 5.0)
        local_add(personne.sexe is not None, _(u"gender"), 5.0)
        local_add(personne.place_i_live, _(u"where you live"), 5.0)
        local_add(personne.date_naissance, _(u"when you were born"), 5.0)

        nb = PersonneTravel.objects.filter(personne=personne,
                                           date_v_fin__isnull=True).count()
        local_add(nb, _(u"at least one travel"), 20.0)

        local_add(personne.place_of_birth, _(u"where you were born"), 2.14)
        local_add(personne.langue, _(u"mother tongue"), 2.14)

        local_add(personne.url_photo_profil, _(u"a profile picture"), 6.67)
        local_add(personne.url_photo_banniere, _(u"a banner picture"), 5.00)
        local_add(personne.nb_enfants is not None,
                  _(u"how many children you have"), 1.43)

        local_add(personne.langues2.count(), _(u"other spoken languages"), 6.67)
        local_add(personne.niveau_etudes, _(u"level of study"), 2.14)
        local_add(personne.programmes2.count(), _(u"subjects"), 1.43)
        local_add(personne.employer_current, _(u"current employer"), 2.14)
        local_add(personne.employer_previous, _(u"previous employer"), 1.43)
        local_add(personne.profession, _(u"job"), 2.14)
        local_add(personne.activites2.count(), _(u"activities"), 1.43)
        local_add(personne.hobbies2.count(), _(u"hobbies"), 2.14)
        local_add(personne.types_permis2.count(), _(u"driving licences"), 1.43)
        local_add(personne.personnalites2.count(), _(u"personality"), 2.14)
        local_add(personne.est_fumeur is not None,
                  _(u"whether you smoke"), 1.43)
        local_add(personne.custom_zodiac_sign, _(u"star sign"), 1.43)
        local_add(personne.self_description, _(u"a description of you"), 6.67)
