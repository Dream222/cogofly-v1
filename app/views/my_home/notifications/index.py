    ...
    def post(self, request, *args, **kwargs):
        ...
        if post['csrfmiddlewaretoken'] == csrf(request)['csrf_token']:
            ...
            if post.get('id_personne_accept'):
                ...
                msg_head = _(u'Invitation accepted')
                msg_to_show = _(u"{} has been notified that you accepted the "
                                u"invitation").format(p_dst.full_name())
                msg_to_send = _(u"I've accepted your invitation")
                ...
                p_dst = Personne.objects.get(pk=id_dst)
                msg_head = _(u'Invitation declined')
                msg_to_show = _(u"{} has been notified that you declined the "
                                u"invitation").format(p_dst.full_name())
                msg_to_send = _(u"I've declined your invitation.\n"
                                u"The reason is: {}").format(
