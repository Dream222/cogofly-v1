...
class EditView(LoginRequiredMixin, PubliciteMixin, ProgressionMixin,
    ...
    def get(self, request, *args, **kwargs):
        retour = super(EditView, self).get(request, *args, **kwargs)
    ...
    def form_valid(self, form):
        ...
        self.request.session['message'] = (
            _(u'Congratulations, your profile has been successfully updated!'),
            _(u'Please note that you can amend all practical and optional '
              u'information, and also check out the online help section, '
              u'at any time via your profile.'),
            u'',
            u'<b>{}</b>'.format(
                _(u'Please also bear in mind that a more complete profile '
                  u'will attract more attention. Increase your chances!')
            ),
            _(u'Close'),
        )
