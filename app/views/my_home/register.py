...
class RegisterView(generic.FormView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['agree_with_toc_and_tos'] = \
            _(u"By clicking the Sign Up button, you agree to our "
              u"<a href=\"{0}\" target=\"_blank\">Terms &amp; Conditions</a> "
              u"and confirm that you have read our "
              u"<a href=\"{1}\" target=\"_blank\">Data Usage Policy</a>, "
              u"including our use of Cookies, mobile app, and APIs "
              u"(Facebook, Twitter, Google+, LinkedIn, etc.).")\
            .format(
                reverse('terms_and_conditions'),
                reverse('terms_of_service')
            )
        context['common'] = common.infos
        context['titre'] = _(u'Sign up')
    ...
    def form_valid(self, form):
        ...
        if password1 != password2:
            form.add_error('password2', _(u'Passwords do not match'))
        ...
        try:
            ...
            form.add_error('username', _(u'This username is already used'))
            return super(RegisterView, self).form_invalid(form)
        ...
        if 'development' not in self.request.META['HTTP_HOST']:
            EmailMessage(
                subject=_(u'Thanks again for signing up.'),
                body=_(u'We sincerely hope that you will appreciate this new '
                       u'and innovative international social network, '
                       u'for which the operative word is “sharing”\n'
                       u"To validate your registration, "
                ...
                bcc=[u'cogofly@gmail.com']).send()

        self.request.session['message'] = [
            _(u'Thanks for signing up!'),
            _(u'An email confirmation has been sent to you.'),
            _(u'Please check your mailbox in order to activate your account, '
              u'via the link provided, and start the adventure!'),
